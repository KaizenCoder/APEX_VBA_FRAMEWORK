...
<#
.SYNOPSIS
    Interface graphique simple pour le hub de communication APEX (MVP Pièces Jointes)

.DESCRIPTION
    Fournit une GUI pour lire/écrire des messages et attacher UN fichier par message.
